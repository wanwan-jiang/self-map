<template>
  ...
  >
    <div
      class="flex w-full flex-1 flex-col items-center justify-center px-4 py-10 md:py-14"
    >
      ...
      <div class="max-w-xl space-y-6">
        <h1 class="font-headline font-extrabold text-4xl md:text-6xl tracking-tight text-on-background">测评已完成</h1>
