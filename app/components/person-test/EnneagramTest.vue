...
import { ENNEAGRAM_TYPE_KEY } from "~/variables/variable";
...
const {
  ...
  goPrev,
  goNext,
} = await usePersonTest(ENNEAGRAM_TYPE_KEY);

const handleSubmit = async (): Promise<void> => {
  await usePersonSubmit(ENNEAGRAM_TYPE_KEY, answers);
};
